export default class calculator {
     ...
     */
     ...
     [
         { name: "Mogyorósi Ferenc", email: "mogyorosi.ferenc@nav.gov.hu"},
         { name: "Mogyorósini Futó Kinga", email: "mogyorosine.kinga@nav.gov.hu"}
     ];
     ...
     */    
     ...
     [
         { name: "Mogyorósi Ferenc", price: 10, stock: 1},
         { name: "Mogyorósini Futó Kinga", price: 20, stock: 3, active: true}
     ];
